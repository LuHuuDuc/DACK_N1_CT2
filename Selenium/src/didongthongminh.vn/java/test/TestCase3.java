...
public class TestCase3 {
    ...
    public void TestCase3() throws IOException, InterruptedException {
        ...
        Thread.sleep(3000);
        WebElement QTY = wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(".product-price > div:nth-child(2) > span:nth-child(1) > input:nth-child(2)"))));
        QTY.clear();
        QTY.sendKeys("2");
